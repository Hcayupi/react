...
import { ResponsiveContainer, XAxis, BarChart, CartesianGrid, YAxis, Tooltip, Bar } from 'recharts';

function RevnueChart() {
    const data = [
        { month: "Juan", revenue: 45000, expenses: 32000 },
