    ...
    return (
        ...
        rounded-2xl border border-slate-200/50 dark:border-slate-700/50'>
            <div className='p-6 border-b border-slate-200/50 dark:border-slate-700/50'>
                ...
                <button className='text-blue text-blue-700 text-sm font-medium'>
                    View All
                </button>
            </div>
            <div className='p-6'>
                <div className='space-y-4'>
                    {activities.map((activity) => {
                        return <div className='flex items-start space-x-4 p-3 rounded-xl hover:bg-slate-50
                    dark:hover:bg-slate-800/50
                    transition-colors'>
                            <div className={`p-2 rounded-lg ${activity.bgColor}`}>
                                <activity.icon className={`${activity.bgColor}`} />
                            </div>
                                <div className='flex-1 min-w-0'>
                                    ...
                                    <div className='flex items-center-safe space-x-1 mt-1'>
                                        <Clock className="w-2 h-3 text-slate-400" />
